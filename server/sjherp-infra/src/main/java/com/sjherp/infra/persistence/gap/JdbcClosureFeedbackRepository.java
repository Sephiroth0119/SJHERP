...
public class JdbcClosureFeedbackRepository implements ClosureFeedbackRepository {
 ...
 public boolean claim(long taskId,long candidateId,String ref,String summary,String operator){return jdbc.update("INSERT INTO closure_feedback(tenant_id,task_id,candidate_id,evidence_reference,evidence_summary,created_by,created_at) VALUES(0,?,?,?,?,?,?) ON DUPLICATE KEY UPDATE id=id",taskId,candidateId,ref,summary,operator,LocalDateTime.now(ZoneOffset.UTC))==1;}
}
